/****************************************************************************
** Meta object code from reading C++ file 'localisation_app.h'
**
...
#include "../localisation_app.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'localisation_app.h' doesn't include <QObject>."
...
void Triangulation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Triangulation *_t = static_cast<Triangulation *>(_o);
        switch (_id) {
...
const QMetaObject Triangulation::staticMetaObject = {
    { &Applet::staticMetaObject, qt_meta_stringdata_Triangulation,
