...
#include "../bench/generic/register.h"
...
static const char qt_meta_stringdata_Register[] = {
    "Register\0\0changed()\0regname\0"
    "signal_updateSet(QString)\0"
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signal_updateSet((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->signal_updateGet((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Register::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Register,
...
// SIGNAL 1
void Register::signal_updateSet(const QString & _t1)
{
...
// SIGNAL 2
void Register::signal_updateGet(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
