...
public:
    ...
    */
    ...
    // Define of master versions
    #define VERSION_NONE                0
    #define VERSION_MOBD                1
    #define VERSION_UPID                2
    #define VERSION_RDUM                3
    #define VERSION_RDUM_SPIMASTER      4
    #define VERSION_NOBOARD             (-1)
    ...
    */
    ...
    /* initializes applet*/
    void suspend_applet();
    /* list of all register .this will return list of data elements*/
    QStringList registers_list() const {return m_applet_data.keys();}
    /* list of all controls*/
    QStringList controls_list() const;
    QStringList functions_list() const {return m_AppFuncMap.keys();}
